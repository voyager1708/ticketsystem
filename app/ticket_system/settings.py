...
MIDDLEWARE = [
    ...
    # 認証未提供の 403 を 401 に統一（REST の慣習に合わせる）
    'ticket_system.exceptions.NormalizeUnauthorizedMiddleware',
]
...
REST_FRAMEWORK = {
    ...
    # 未認証時に 403 が返る DRF の挙動を補正し、「認証情報なし」は 401 に統一する
    'EXCEPTION_HANDLER': 'ticket_system.exceptions.exception_handler',
}
